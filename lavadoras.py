...
# =========================================================================
# 1. BASE DE DATOS MAESTRA: FORMATO DIRECTO SIN BLOQUEOS DE MEMORIA
# =========================================================================
LAVADORAS_MODELOS = [
...
# Inicializar modelos personalizados en la sesión
if "modelos_personalizados" not in st.session_state:
    st.session_state["modelos_personalizados"] = []

# Unificar lista global de modelos disponibles
todos_los_modelos = LAVADORAS_MODELOS + st.session_state["modelos_personalizados"]

# =========================================================================
# 2. FUNCIONES DE DIAGNÓSTICO AVANZADO
# =========================================================================
def detectar_marca(modelo):
    ...
    if "MAYTAG" in modelo_up: return "MAYTAG"
    if "GE" in modelo_up or "GENERAL" in modelo_up: return "GE"
    return "WHIRLPOOL"
...
# =========================================================================
# 3. INTERFAZ GRÁFICA MÓVIL (MÉTODO SECUENCIAL GARANTIZADO)
# =========================================================================
...
if modelo_ingresado:
    coincidencias = difflib.get_close_matches(modelo_ingresado, todos_los_modelos, n=1, cutoff=0.3)
    ...
    if coincidencias:
        ...
        if st.button(f"➕ ¿Desea integrar '{modelo_ingresado}' permanentemente?"):
            st.session_state["modelos_personalizados"].append(modelo_ingresado)
    ...
    # FASE 2: PANEL DUAL DE TRABAJO (BÚSQUEDA EXTRACTIVA SENSIBLE)
    errores_marca = CATALOGO_ERRORES.get(marca_actual, {})
    ...
    # 1. Evaluar si usó la opción del menú desplegable
    ...
    # 2. Evaluar si escribió texto libre
    elif falla_escrita:
